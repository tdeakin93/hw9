...
The person responsible for this code is: ${
    data.name
  } and their github username is: ${data.github_username}
Account: [https://github.com/${data.github_username}](https://github.com/${
    data.github_username
  })
If you have questions regarding this application, feel free to contact: ${
    data.email
  }
